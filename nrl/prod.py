...
def main():
	...
	prod_functions.save_to_local_machine(f'predictions/nrl_{todays_date}.json', todays_json)
	todays_features_with_info.to_csv(f'predictions/nrl_{todays_date}.csv', index=False)
